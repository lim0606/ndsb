...
DataCIFAR10Layer<Dtype>::~DataCIFAR10Layer<Dtype>() {
...
template <typename Dtype>
void DataCIFAR10Layer<Dtype>::DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void DataCIFAR10Layer<Dtype>::InternalThreadEntry() {
...
//    }
    this->data_transformer_.TransformAffine(cv_img, &(this->transformed_data_));
...
INSTANTIATE_CLASS(DataCIFAR10Layer);
REGISTER_LAYER_CLASS(DATA_CIFAR10, DataCIFAR10Layer);
}  // namespace caffe
