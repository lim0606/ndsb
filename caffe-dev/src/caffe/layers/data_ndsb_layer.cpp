...
DataNDSBLayer<Dtype>::~DataNDSBLayer<Dtype>() {
...
template <typename Dtype>
void DataNDSBLayer<Dtype>::DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void DataNDSBLayer<Dtype>::InternalThreadEntry() {
...
//    }
    this->data_transformer_.TransformNDSB(cv_img, &(this->transformed_data_));
...
INSTANTIATE_CLASS(DataNDSBLayer);
REGISTER_LAYER_CLASS(DATA_NDSB, DataNDSBLayer);
}  // namespace caffe
